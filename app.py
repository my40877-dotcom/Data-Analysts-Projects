...
# --- LOAD DATA ---
# Ensure your CSV filenames match exactly
...
# Create the Phase column globally immediately after loading
...
# --- DATA PROCESSING: PRE-CRISIS VS CRISIS ---
# Monthly order count
...
# Merge with orders to link timestamps and status
...
# Group by Phase to see the impact
...
# Display KPI metrics for revenue
...
# Filter for Pre-Crisis data only
pre_crisis_data = df_orders[df_orders['Phase'] == 'Pre-Crisis']

# Find top 5% of customers by total spend
...
# Identify Churn: High-value customers who did NOT order during the Crisis phase
...
# Analyze restaurant performance across phases
...
# Top 10 High-Volume Restaurants with lowest decline
